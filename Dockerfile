...
ENV JAVA_OPTS="-XX:MaxRAMPercentage=75.0 -XX:InitialRAMPercentage=50.0 -Djava.security.egd=file:/dev/./urandom -Duser.timezone=Asia/Taipei -Dspring.profiles.active=prod"
